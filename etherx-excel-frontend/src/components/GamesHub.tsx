    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-4xl p-0 gap-0 max-h-[90vh] overflow-hidden">
        ...
        <div className="p-8 overflow-auto">
          <div className="grid grid-cols-2 gap-6">
            {games.map((game) => (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${game.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
          ...
          {/* Info Box */}
          <div className="mt-8 p-6 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-600/10 border-2 border-blue-500/20">
