...
export function AIChatbot({ open, onClose }: AIChatbotProps) {
  ...
  return (
  <div className="fixed right-0 top-0 h-screen w-80 bg-card border-l border-border flex flex-col shadow-2xl z-[9999] overflow-hidden pointer-events-auto">
      {/* Header */}
      ...
      <div className="p-3 border-t border-border flex-shrink-0">
        <div className="flex gap-2">
          <Input
            ...
            className="flex-1 h-9 text-sm z-[10000]"
            disabled={false}
          />
